...
pred_prior <- data.frame(
  t = rep(grilla_t, times = n * largo_grilla),
  prior_beta_0 = rep(rnorm(n, 1.8806, 0.6269), each = largo_grilla),
  prior_beta_1 = rep(rnorm(n, 0, 0.17), each = largo_grilla),
  prior_sigma = rep(abs(rnorm(n,0,0.8046)), each = largo_grilla)
  ) |> 
