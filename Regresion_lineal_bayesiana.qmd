...
- $\beta_0$ es el logaritmo de la diferencia de la temperatura en la que se encontro el cuerpo y la ambiental.
...
pred_prior <- data.frame(
  prior_beta_1 = abs(rnorm(n, 0.4, 0.075)),
  prior_d = abs(rnorm(n, 1.25, 0.25)),
