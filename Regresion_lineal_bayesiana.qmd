...
ggplot(data_y) +
  ...
  scale_color_manual(values = c("gold")) +
  labs(x = "Tiempo", y = expression(T(t)-T[amb]), color = "Hora | Temperatura") +
  scale_x_continuous(breaks = seq(-4,7,1), limits = c(-4,7)) +
  theme(legend.position = "top")
...
De igual forma que con un solo dato, las cadenas convergen a la misma distribución para todos los parámetros, pero estas son incluso más acotadas que antes. Esto se puede ver en los siguientes gráficos de traza y densidad para cada uno de los parámetros.
