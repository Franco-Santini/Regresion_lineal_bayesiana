...
- Logaritmo de la diferencia de temperatura promedio: $\frac{ln(max(T_{diff}) + min(T_{diff}))}{2} = 2.3026$
...
pred_prior <- data.frame(
  prior_beta_0 = rnorm(n, 2.2513, 0.75),
  prior_beta_1 = rnorm(n, -0.1, 0.13),
...
mean(t_dist_2 >= -6 & t_dist_2 <= 0) # Con valores + y -
...
mean(t_dist_3 >= -6 & t_dist_3 <= 0) # Con valores + y -
